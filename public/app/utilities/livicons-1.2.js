...
"archive-extract":{
    ...
    sh:[
      ...
      {
        i:{
              a:{p:"M22,4V2H5.2C4.537,2,4,2.537,4,3.2v25.601C4,29.463,4.537,30,5.2,30H22v-4h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2v-2h2v-2h-2V8h2V6h-2V4H22zM16.69,13H14v3.4c0,0.331-0.269,0.6-0.6,0.6h-2.801c-0.331,0-0.6-0.269-0.6-0.6V13H7.308c-0.328,0-0.406-0.19-0.176-0.424l4.443-4.4c0.233-0.234,0.614-0.234,0.848,0l4.443,4.4C17.099,12.81,17.021,13,16.69,13z",
              s:"none",
              fl:"#333"}
             },
        f:{}
...
Raphael.fn.createLivicon = function (iconid, iconname, size, color, hovercolor, animate, looped, iteration, customduration, eventtype, icondata, scalefactor, onparent) {
  ...
  //creating an invisible rectangle on the whole canvas to track mouse and tap events
  wholeicon = paper.rect(1,1,size-1,size-1).attr({fill: "#fff", stroke:"none", "stroke-width":0, opacity:0}).toFront();
